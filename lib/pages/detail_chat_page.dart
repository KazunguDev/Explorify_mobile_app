        ...
        child: Row(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(12),
              child: Image.network(
                (widget.product.galleries?[0].url) as String,
                width: 54,
              ),
            ),
            SizedBox(
    ...
    Widget content() {
      return StreamBuilder<List<MessageModel>>(
          stream: MessageService()
              .getMessagesByUserId(userId: (authProvider.user.id) as int),
              ...
              return ListView(
                ...
                children: snapshot.data
                    !.map((MessageModel message) => ChatBubble(
                          isSender: (message.isFromUser) as bool,
                          text: (message.message) as String,
                          product: (message.product) as ProductModel,
                        ))
                    .toList(),
              );
            } else {
