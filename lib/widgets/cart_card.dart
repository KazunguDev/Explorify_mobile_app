    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                      (cart.product!.galleries?[0].url) as String,
                    ),
                  ),
                ),
              ),
              ...
              Column(
                children: [
                  GestureDetector(
                    onTap: () {
                      cartProvider.addQuantity((cart.id) as int);
                    },
                    child: Image.asset(
                  ...
                  GestureDetector(
                    onTap: () {
                      cartProvider.reduceQuantity((cart.id) as int);
                    },
                    child: Image.asset(
          ...
          GestureDetector(
            onTap: () {
              cartProvider.removeCart((cart.id) as int);
            },
            child: Row(
              children: [
                Image.asset(
